...
export declare class BrewController {
    private readonly brewService;
    ...
    create(payload: CreateBrewDto): Promise<import("@prisma/client/runtime").GetResult<{
        id: string;
        userId: string;
        recipeId: string;
        batchLiters: import("@prisma/client/runtime").Decimal;
    ...
    patchBrew(id: string, body: BrewPatchDto): Promise<(import("@prisma/client/runtime").GetResult<{
        id: string;
        userId: string;
        recipeId: string;
        batchLiters: import("@prisma/client/runtime").Decimal;
